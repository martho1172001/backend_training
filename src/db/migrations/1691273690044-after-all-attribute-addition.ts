...
export class AfterAllAttributeAddition1691273690044 implements MigrationInterface {
    name = 'AfterAllAttributeAddition1691273690044'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "employees" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "deleted_at" TIMESTAMP, "name" character varying NOT NULL, "username" character varying NOT NULL, "password" character varying NOT NULL, "joining_date" TIMESTAMP NOT NULL, "is_active" boolean NOT NULL DEFAULT false, "experience" integer NOT NULL, "role" character varying NOT NULL DEFAULT 'Developer', "department_id" integer, CONSTRAINT "PK_b9535a98350d5b26e7eb0c26af4" PRIMARY KEY ("id"))`);
